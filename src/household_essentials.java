 ...
 */
public class household_essentials extends javax.swing.JFrame {

    /**
     * Creates new form household_essentials
     */
    public household_essentials() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabelHousehold = new javax.swing.JLabel();
        ...
        jLabelHousehold.setFont(new java.awt.Font("Leelawadee UI", 1, 36)); // NOI18N
        jLabelHousehold.setText("HOUSEHOLD ESSENTIALS");

        jTable6.setBackground(new java.awt.Color(246, 240, 240));
        jTable6.setFont(new java.awt.Font("Leelawadee UI", 0, 14)); // NOI18N
        jTable6.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {"Paper Towel", "Household Essentials", "$90", "1000"},
                {"Dish Soap", "Household Essentials", "$10", "1000"},
                {"Laundry Detergent", "Household Essentials", "$50", "5000"},
                {"Wipes", "Household Essentials", "$30", "2000"},
                {"Air Fresheners", "Household Essentials", "$60", "3000"},
                {"", null, null, null},
                {"", null, null, null},
                {null, null, null, null},
                {null, null, null, null},
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(household_essentials.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JLabel jLabelHousehold;
